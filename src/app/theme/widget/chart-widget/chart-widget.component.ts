...
export class ChartWidgetComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    setTimeout(() => {
      ...
      this.chartEcommerce = AmCharts.makeChart('sales-analytics', {
        'type': 'serial',
        'theme': 'light',
        'marginRight': 40,
        'marginLeft': 40,
      ...
      this.chartEcommerceLine = AmCharts.makeChart('seo-ecommerce-linechart', {
        'type': 'serial',
        'theme': 'light',
        'marginTop': 0,
        'marginRight': 0,
    ...
    setTimeout(() => {
      ...
      (this.chartEcommerceLine).zoomToIndexes(Math.round((this.chartEcommerceLine).dataProvider.length * 0.3), Math.round((this.chartEcommerceLine).dataProvider.length * 0.55));
    }, 2500);
  }
